<x-modal name="votingInsert" :show="$errors->votingStore->isNotEmpty()" focusable>
    <form method="post" action="{{ route('voting.insert') }}" class="p-6">
        @csrf
        @method('post')
        ...
        <div class="mb-4">
            ...
            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full"
                autocomplete="current-password" placeholder="Type the title" value="{{ old('title') }}" />
        ...
        <div class="mb-4">
            ...
            <x-text-input id="start_time" name="start_time" type="date" class="mt-1 block w-full"
                autocomplete="start_time" value="{{ old('start_time') }}" />
        ...
        <div class="mb-4">
            ...
            <x-text-input id="end_time" name="end_time" type="date" class="mt-1 block w-full"
                autocomplete="end_time" value="{{ old('end_time') }}" />
